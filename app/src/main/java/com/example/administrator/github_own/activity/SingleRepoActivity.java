...
public class SingleRepoActivity extends BaseActivity{
    ...
    public void initDatas() {
        ...
        mDatas = Arrays.asList(getResources().getStringArray(R.array.single_repo_tabs));
        mTabFragments = new ArrayList<>();
        mTabFragments.add(SingleRepoAboutFragment.newInstance(username, reponame));
    ...
    public static void startActivity(Context context, String username) {
        context.startActivity(new Intent(context, SingleRepoActivity.class).putExtra(USER_NAME,
                username));
    }
