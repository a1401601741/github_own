...
public class SearchRepoListAdapter extends RecyclerArrayAdapter<SearchRepos.ItemsBean> {


    public SearchRepoListAdapter(Context context) {
        super(context);
    }

    @Override
    public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
        return new BaseViewHolder<SearchRepos.ItemsBean>(parent, R.layout.item_repo) {
            @Override
            public void setData(SearchRepos.ItemsBean item) {
