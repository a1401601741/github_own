...
package com.example.administrator.github_own.recyclerview.adapter;
...
abstract public class RecyclerArrayAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public void addAll(Collection<? extends T> collection) {
        ...
        log("addAll notifyItemRangeInserted " + (headers.size() + getCount() - dataCount + 1) +
                "," + (dataCount));
    ...
    public void insertAll(T[] object, int index) {
        ...
        log("insertAll notifyItemRangeInserted " + ((headers.size() + index + 1) + "," +
                (dataCount)));
    }
        ...
        for (ItemView headerView : headers) {
            if (headerView.hashCode() == viewType) {
                ...
                if (view.getLayoutParams() != null)
                    layoutParams = new StaggeredGridLayoutManager.LayoutParams(view
                            .getLayoutParams());
                else
                    layoutParams = new StaggeredGridLayoutManager.LayoutParams(ViewGroup
        ...
        if (mItemLongClickListener != null) {
            viewHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    return mItemLongClickListener.onItemLongClick(viewHolder.getAdapterPosition()
                            - headers.size());
                }
            });
        }
